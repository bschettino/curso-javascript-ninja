...
*/
var pessoa = { nome: 'Bruno', sobrenome: 'Schettino', sexo: 'Masculino',
               idade: 26, altura: 1.62, peso: 65, andando: false,
...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Bruno Schettino'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura(); // 'Minha altura é 1.62m.'
...
*/
pessoa.andar(100); pessoa.andar(20); pessoa.andar(80);

...
segundo parâmetro.
*/
function exercicio2( array, numero ) {
  return array[numero];
}
...
*/
var arrayEcletico = [ 1, NaN, { nome: 'Bruno' }, 'quarto', [ 1, 2, 3 ] ];

/*
Invoque a função criada acima, fazendo-a retornar todos os valores do último
array criado.
*/
console.log(exercicio2(arrayEcletico, 0));
console.log(exercicio2(arrayEcletico, 1));
console.log(exercicio2(arrayEcletico, 2));
console.log(exercicio2(arrayEcletico, 3));
console.log(exercicio2(arrayEcletico, 4));
